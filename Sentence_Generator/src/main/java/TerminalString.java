...
/**
 * Class TerminalString is to identify elements that are normal words that is not changed to
 * anything else when expanding the grammar
 */
public class TerminalString extends Definition {

  /**
   * Constructor for class TerminalString
   * @param definition - Consists of a non-terminal and its set of "productions" or "expansions".
   */
  public TerminalString(String definition) {
    super(definition);
  }
