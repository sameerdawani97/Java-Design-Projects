/**
 * Class SpecialCharacter is to identify the special characters
 */
public class SpecialCharacter extends Definition {

  /**
   * Constructor for class SpecialCharacter
   * @param definition - Consists of a non-terminal and its set of "productions" or "expansions".
   */
  public SpecialCharacter(String definition) {
    super(definition);
  }
